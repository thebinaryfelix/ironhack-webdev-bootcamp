describe('Stack: ', function () {
  ...
  describe('Stack methods usage', function () {
    ...
    it("Should return false if the stack is full", function () {
      ...
      expect(stack.push(88)).toEqual(false);
    });
    ...
    it("Should return false if there are no elements in the stack", function () {
...
describe('Queues', function () {
  ...
  describe('Queue methods usage', function () {
    ...
    it("Should return false if the stack is full", function () {
      ...
      expect(queue.enqueue(88)).toEqual(false);
    });
    ...
    it("Should return false if there are no elements in the queue", function () {
